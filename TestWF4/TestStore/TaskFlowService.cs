...
namespace TestStore
{
    public class TaskFlowService : ITaskFlowService
    {
        ...
        public void RunInstance(Request request, string bookmark)
        {
            ...
            WorkflowApplication application1 = new WorkflowApplication(new TaskFlow());
            ...
            application1.Load(request.WokflowId.Value);

            application1.ResumeBookmark(bookmark, request);
